...
function fallbackPublication(){
	...
	function fallbackPublication5(){
		var currentlocation = document.getElementsByClassName("publication-5")[0];
		var eventlocation = document.getElementsByClassName("Evenements")[0];
...
function gotoEvent(){
	...
	function gotoEvent5(){
		var currentlocation = document.getElementsByClassName("publication")[0];
		var eventlocation = document.getElementsByClassName("publication-5")[0];
